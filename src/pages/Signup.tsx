export const Signup = () => {
  return (
    <section className="container flex justify-center items-center flex-col my-4">
      <h1 className="text-3xl mt-8 text-center font-bold md:text-4xl bg-clip-text text-transparent bg-gradient-to-r from-sky-500 to-violet-500">
        Signup
      </h1>
